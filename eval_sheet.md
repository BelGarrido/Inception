...
Before starting the evaluation, run this command in the terminal: **este comando sale del scope del proyecto**
...
Versión	Nombre clave	Fecha de publicación	Fin del ciclo de vida («end of life», EOL)	Fin del LTS	Fin del ELTS	Estado
15	Duke	Por determinar	Por determinar	Por determinar	Por determinar	Nombre clave anunciado
14	Forky	Por determinar	Por determinar	Por determinar	Por determinar	testing — sin fecha de publicación establecida
13	Trixie	09-08-2025	09-08-2028	30-06-2030	30-06-2035	Versión estable actual
**12	Bookworm	10-06-2023	10-06-2026	30-06-2028	30-06-2033	Versión oldstable actual**
11	Bullseye	14-08-2021	14-08-2024	31-08-2026	30-06-2031	Versión oldoldstable actual, bajo soporte LTS
...
Ensure that NGINX can be accessed by port 443 only. Once done, open the page. ??????????????????????????? cambiar
...
To access it, open https://login.42.fr in your browser, where login is the login of the evaluated learner. You shouldn't be able to access the site via http://login.42.fr. If something doesn't work as expected, the evaluation process ends now.
